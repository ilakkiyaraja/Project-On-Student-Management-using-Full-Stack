                        ...
                        <form method="post" action="">
                            <div class="col-md-6">
                                <div style="width: 471px; height: 620px; margin-left:270px;" class="card px-5 py-5">
                                    <h2 class="display-5">Post Result</h2>
                                    <br>
                                    <input class="form-control" name="regno" required placeholder="Reg.no"
                                        type="text"> <br>
                                    ...
                                    <br>
                                    <input class="form-control" name="marks" required placeholder="Marks Obtained"
                                        type="text"> <br>
                                        <input class="form-control" name="grade" required placeholder="Grade"
                                        type="text"> <br>
...
$sql="INSERT INTO marks (`Reg_no`, `Ename`, `Etype`, `Sub`, `Marks`, `Grade`) VALUES ('$regno', ' $Ename', '$Etype', ' $sub', '$marks', '$grade')";

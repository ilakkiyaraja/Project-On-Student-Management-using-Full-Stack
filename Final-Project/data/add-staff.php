                        ...
                        <form method="post" action="">
                            <div class="col-md-6">
                                <div style="width: 471px; height: 590px; margin-left:270px;" class="card px-5 py-5">
                                    ...
                                    <input class="form-control" name="name" required placeholder="Staff Name" type="text"> <br>
                                    <input type="text" name="qual" required placeholder="Qulaifiication" class="form-control">
                                    <br>
                                    <input type="text" name="pay" required placeholder="Salary" class="form-control"> <br>
...
$sql="INSERT INTO staff (`id`, `Staff_name`, `Staff_qulaify`, `Staff-pay`, `username`, `password`) VALUES (NULL, ' $staffname', '$Qualify', ' $payment', '$username', '$pass')";
$result=mysqli_query($conn,$sql);
if($result){
  echo"<h3 style='color:green;'>Satff added</h3>";
}
else{
    echo"error";
}

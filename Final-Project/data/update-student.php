...
if(isset($_POST['enter'])){
    ...
    $sql="UPDATE `student` SET  `Name` = '$studentname', `Reg_no` = '$regno', `Department` = '$department', `Batch` = '$batch', `Age` = '$age', `Number` = '$number', `Pnumber` = '$Pnumber', `Email` = '$email' WHERE `id` = '$id1'";
                ...
                <form class=" row flex-nowrap" method="post" action="">
                    ...
                    <div class="col-md-4">
                        ...
                        <div style="width: 417px; height: 515px;" class="card px-5 py-5">
                            <h2 class="display-5">Update Student Details</h2>
                            <br>

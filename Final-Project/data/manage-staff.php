...
<h2 style="text-align: center;" >STAFF DETAILS</h2> <br>  <br>
    ...
    <?php
            ...
            if($result){
             while($row = mysqli_fetch_assoc($result)){
                ...
                <a class='text-white text-decoration-none' href='update-staff.php? update-id=$id'><i class='fa fa-pencil'></i> Update</a>  
                </button>
              </td>
              <td>
              <button class='btn btn-danger' >
              <a  class='text-white text-decoration-none' href='delete-staff.php? delete-id=$id'><i class='fa fa-trash'></i> Delete</a>
              </button>
            </td>
          </tr>
                 </tr>";
